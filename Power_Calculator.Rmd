...
```{r setup, include=FALSE}
power_calc_multiple_runs = function(all_zips, p_adjust_method_string, beta_or_M_string){
...
```{r setup, include=FALSE}
merge_data = function(all_zips, p_adjust_method_string,beta_or_M_string){
power_calc_val = power_calc_multiple_runs(all_zips,p_adjust_method_string,beta_or_M_string)
...
save_data_name = paste0("/PowerCalc_",y_parameter_string,"_",varied_parameter_string,"/")
...
png(paste0(save_data_name ,"LinePlot_",y_parameter,"_vs_Power_",varied_parameter,"_step_",varied_param_i,"_",p_adjust_method_string,"_",beta_or_M_string,".png"))
print(fig)
dev.off()
}
}
...
png(paste0(save_data_name,"HeatMap_",y_parameter,"_vs_",x_parameter,"_colorfill_Power",test_string,"_",p_adjust_method_string,"_",beta_or_M_string,".png"))
print(fig)
dev.off()
}
...
```{r setup, include=FALSE}
PowerCalc = function(num_zips,p_adjust_method_string,beta_or_M_string,y_parameter_string,x_parameter_string,color_string,test_vector_string){
  all_test_all_zips = merge_data(num_zips,p_adjust_method_string,beta_or_M_string)
  save_data_name = paste0("/PowerCalc_",y_parameter_string,"_",x_parameter_string,"/")
  dir.create(paste0(getwd(),"/PowerCalc_",y_parameter_string,"_",x_parameter_string))
  write.table(all_test_all_zips, paste0(save_data_name,"PowerCalc_tests_results_",beta_or_M_string,"_",p_adjust_method_string,".txt"), col.names = TRUE)
...
```{r setup, include=FALSE}
PowerCalc(6,"BH","M","n_samples","effect_size","Power",c("t_test","limma","KS_test"))
```
