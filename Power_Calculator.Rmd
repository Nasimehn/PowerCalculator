...
```{r setup, include=FALSE}
power_calc_multiple_runs = function(all_zips, p_adjust_method_string){
...
```{r setup, include=FALSE}
merge_data = function(all_zips, p_adjust_method_string){
power_calc_val = power_calc_multiple_runs(all_zips,p_adjust_method_string)
...
```{r setup, include=FALSE}
PowerCalc = function(num_zips,p_adjust_method_string,y_parameter_string,x_parameter_string,color_string,test_vector_string){
  
  all_test_all_zips = merge_data(num_zips,p_adjust_method_string)
