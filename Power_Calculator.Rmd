...
local_t_test = function(all_zips, zip_file_order){
  simulated_data_frame = extract_data_from_zip(all_zips,2,"Simulated_data")
  n_sample_per_group= get_num_samp_per_group(all_zips, zip_file_order, simulated_data_frame)
  n_group1 = n_sample_per_group[1]
  n_group2 = n_sample_per_group[2]
  t_test_output = t.test(simulated_data_frame[,1:n_group1],simulated_data_frame[,(n_group1+1):ncol(simulated_data_frame)])
