...
```{r setup, include=FALSE}
all_test_output = run_all_test(2,2)

p_adjusted = multitest_p_adjest(all_test_output,"BH")
```
...
```{r setup, include=FALSE}
heat_map = function(data_df,x_parameter_string,y_parameter_string,color_string,test_string,p_adjust_method_string,beta_or_M_string){
...
PowerCalc = function(num_zips,p_adjust_method_string,beta_or_M_string,y_parameter_string,x_parameter_string,color_string,test_vector_string){
  ...
  write.table(all_test_all_zips, paste0("PowerCalc_tests_results_",beta_or_M_string,"_",p_adjust_method_string,".txt"), col.names = TRUE)
  ...
  for (test in 1:length(test_vector_string)){
    heat_map(all_test_all_zips,x_parameter_string, y_parameter_string, color_string, test_vector_string[test],p_adjust_method_string,beta_or_M_string)
  }
}
```

```{r setup, include=FALSE}
PowerCalc(15,"BH","M","n_samples","effect_size","Power",c("t_test","limma","KS_test"))
```